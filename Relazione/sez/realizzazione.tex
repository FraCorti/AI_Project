...
\subsubsection{Configurazione}
Tramite il metodo \textit{fit()} presente in Sklearn è possibile stabilire:
\begin{enumerate}
	\item \textbf{precision}: \href{https://scikit-learn.org/stable/modules/generated/sklearn.metrics.precision_score.html#sklearn.metrics.precision_score} nel nostro caso, maggiori informazioni al seguente link \href{https://keras.io/losses/}{\textit{precision}};	\item \textbf{recall}: \href{https://scikit-learn.org/stable/modules/generated/sklearn.metrics.recall\_score.html#sklearn.metrics.recall\_score} nel nostro caso, maggiori informazioni al seguente link \href{https://keras.io/losses/}{\textit{recall}};
	\item \textbf{f1}: nel nostro caso, maggiori informazioni al seguente link \href{https://scikit-learn.org/stable/modules/generated/sklearn.metrics.f1_score.html}{\textit{f1}}.  
\end{enumerate} 
